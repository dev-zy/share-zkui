...
import com.devzy.share.zkui.vo.ZKNode;
...
public class Home extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            templateParam.put("scmRepo", PropertiesConfigUtil.getProperty("scmRepo"));
            templateParam.put("scmRepoPath", PropertiesConfigUtil.getProperty("scmRepoPath"));
